        ...
        <div class="grid grid-cols-4 gap-7">
            ...
            <div class="col-span-4  md:col-span-3 mb-3">
                ...
                <div
                    ...
                    <ol v-if="tagArticles && tagArticles.length > 0"
                        class="mt-3 divide-y divider-gray-200 dark:divide-gray-700">
                        <li v-for="(article, index) in tagArticles" :key="index">
                    ...
                    <!-- 该标签 下没有文章提示，指定为 flex 布局，内容垂直水平居中，并纵向排列 -->
                ...
                <nav v-if="tagArticles && tagArticles.length > 0" aria-label="Page navigation example"
...
function getTagArticles(currentNo) {
    ...
    //调用分页接口渲染数据
    getTagArticlePageList({ current: currentNo, size: size.value, tagId: tagId.value }).then((res) => {
        if (res.success) {
            tagArticles.value = res.data
...
watch(route, (newRoute, oldRoute) => {
    tagName.value = newRoute.query.tagName
    tagId.value = newRoute.query.tagId
    getTagArticles(current.value)
}) 
</script>
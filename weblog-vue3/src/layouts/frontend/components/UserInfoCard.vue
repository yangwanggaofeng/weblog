<template>
    ...
    <div
        ...
        <div class="flex flex-col items-center">
            <!--博主头像-->
            <svg t="1718167901004" class="icon w-24 h-24 mb-3 rounded-full shadow" viewBox="0 0 1024 1024" version="1.1"
                xmlns="http://www.w3.org/2000/svg" p-id="6771" width="200" height="200">
                <path
            ...
            <div class="flex justify-center gap-2 ">
                ...
                <svg v-if="blogSettingsStore.blogSettings.githubHomepage"
                    @click="jump(blogSettingsStore.blogSettings.githubHomepage)" t="1698029949662"
                ...
                <svg v-if="blogSettingsStore.blogSettings.csdnHomepage"
                    @click="jump(blogSettingsStore.blogSettings.csdnHomepage)" t="1718168003395"
                    class="icon w-7 h-7 mt-5 " viewBox="0 0 1024 1024" version="1.1"
                ...
                <svg v-if="blogSettingsStore.blogSettings.giteeHomepage"
                    @click="jump(blogSettingsStore.blogSettings.giteeHomepage)" t="1718168052845"
                    class="icon w-7 h-7 mt-5 " viewBox="0 0 1024 1024" version="1.1"
